...
namespace OpenGL
{
    ...
    public static unsafe partial class GL
    {
        ...
        public static int glGetShaderi(uint shader, int status)
        {
            return _glGetShaderi(shader, status);
        }
        ...
        public static int glGetProgrami(uint program, int status)
        {
            return _glGetProgrami(program, status);
        }
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int PFNGLGETSHADERIPROC(uint shader, int status);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int PFNGLGETPROGRAMIPROC(uint program, int status);
        ...
        private static PFNGLGETSHADERIPROC _glGetShaderi;
        ...
        private static PFNGLGETPROGRAMIPROC _glGetProgrami;
		...
		public static void Import(GetProcAddressHandler loader)
        {
            ...
            //_glGetShaderi = Marshal.GetDelegateForFunctionPointer<PFNGLGETSHADERIPROC>(loader.Invoke("glGetShaderi")); TODO: fix this
            //_glGetProgrami = Marshal.GetDelegateForFunctionPointer<PFNGLGETPROGRAMIPROC>(loader.Invoke("glGetProgrami")); TODO: fix this
